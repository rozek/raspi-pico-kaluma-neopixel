...
let Display = SPIDisplay(null, 16,16);
  ...
  Display.setPixelRGB(0,0, 16,0,0);
  Display.setPixelRGB(2,0, 0,16,0);
  Display.setPixelRGB(4,0, 0,0,16);

  Display.setPixelRGB(10,0, 16,16,0);
  Display.setPixelRGB(12,0, 0,16,16);
  Display.setPixelRGB(14,0, 16,0,16);
Display.show();
